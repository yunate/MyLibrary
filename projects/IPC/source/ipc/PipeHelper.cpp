...
bool ServerPipeHelper::OnRegist(const std::shared_ptr<ipc::Message>& spMsg)
{
     ...
     bool result = [&spManager, &spMsg]()
     {
         ...
         std::wstring newName =
             std::wstring(L"Pipe") + GenerateGuidW() + L"_" + L"1.0.0.1";
